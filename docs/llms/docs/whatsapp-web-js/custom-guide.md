commit 890515d0aa92f91a6befcf83c49ba15d106b4795
Author: Willian Custodio Quintino <williancustodioquintino@gmail.com>
Date:   Sun Oct 12 14:15:00 2025 -0300

    Add WhatsApp Web.js documentation
    
    Added WhatsApp Web.js (wwebjs) custom guide for future WhatsApp automation integration (Phase 3+).
    
    Features covered:
    - Authentication (QR Code, LocalAuth)
    - Sending/receiving messages and media
    - Group management
    - Contact interactions
    - Events and webhooks
    - Best practices and error handling
    
    Updated documentation index: 13 libraries total
    Contributed to https://github.com/WillianQuintino/claude-llms-docs
    
    🤖 Generated with [Claude Code](https://claude.com/claude-code)
    
    Co-Authored-By: Claude <noreply@anthropic.com>

diff --git a/docs/llms/docs/whatsapp-web-js/custom-guide.md b/docs/llms/docs/whatsapp-web-js/custom-guide.md
new file mode 100644
index 0000000..2e8fe19
--- /dev/null
+++ b/docs/llms/docs/whatsapp-web-js/custom-guide.md
@@ -0,0 +1,545 @@
