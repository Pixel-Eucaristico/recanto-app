      ...
      <div className="w-full flex flex-col items-center justify-center max-w-md text-center">
        ...
        <div className="card w-96 bg-base-100 shadow-xl p-8 pt-0">
          <div className="card-body">
            <h2 className="card-title justify-center mb-4">Entrar</h2>
          ...
          <p className="text-xs mt-4">
            Não possui uma conta? <a href="/app/register" className="text-primary hover:underline">Cadastre-se</a>
          </p>
          <p className="text-xs mt-2">
            Paz e Unção! Seja bem-vindo ao nosso recanto digital.
          </p>
        </div>
      </div>
    </div>
