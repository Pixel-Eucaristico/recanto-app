...
export function ContinueBanner({ progress, onDismiss, onContinue }: ContinueBannerProps) {
  return (
    <div className="sticky top-2 z-10 mt-2 bg-info/15 border border-info/30 rounded-md mx-3 md:mx-6 px-3 md:px-6 py-2 flex items-center justify-between gap-3 flex-wrap">
